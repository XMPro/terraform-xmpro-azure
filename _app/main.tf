...
module "ad_app_service" {
  ...
  custom_identity_name    = var.name_ad_identity
...
module "ds_app_service" {
  ...
  custom_identity_name    = var.name_ds_identity
...
module "ai_app_service" {
  ...
  custom_identity_name    = var.name_ai_identity
...
module "sm_app_service" {
  ...
  custom_identity_name    = var.name_sm_identity
