...
locals {
  ...
  ad_base_url = var.enable_custom_domain ? "https://ad.${local.dns_zone_name}/" : "https://app-ad-${var.company_name}-${var.name_suffix}.azurewebsites.net"
  ds_base_url = var.enable_custom_domain ? "https://ds.${local.dns_zone_name}/" : "https://app-ds-${var.company_name}-${var.name_suffix}.azurewebsites.net"
  ai_base_url = var.enable_ai ? (var.enable_custom_domain ? "https://ai.${local.dns_zone_name}/" : "https://app-ai-${var.company_name}-${var.name_suffix}.azurewebsites.net") : ""
