...
module "applications" {
  ...
  log_analytics_workspace_id       = length(data.azurerm_log_analytics_workspace.this) > 0 ? data.azurerm_log_analytics_workspace.this[0].id : ""
  ...
  name_ad_identity           = var.name_ad_identity
  name_ds_app_service        = var.name_ds_app_service
  name_ds_identity           = var.name_ds_identity
  name_sm_app_service        = var.name_sm_app_service
  name_sm_identity           = var.name_sm_identity
  name_ai_app_service        = var.name_ai_app_service
  name_ai_identity           = var.name_ai_identity
