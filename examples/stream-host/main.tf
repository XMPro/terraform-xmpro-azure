...
module "resource_group" {
  ...
  source = "github.com/XMPro/terraform-xmpro-azure//modules/resource-group?ref=v5.5.6"
...
module "stream_host" {
  ...
  # Using release version:
  source = "github.com/XMPro/terraform-xmpro-azure//modules/stream-host-container?ref=v5.5.6"
