...
output "mqtt_broker_fqdn" {
  description = "MQTT broker FQDN (empty if stream connector disabled)"
  value       = module.infrastructure.mqtt_broker_fqdn
}

output "mqtt_broker_url" {
  description = "MQTT broker connection URL (empty if stream connector disabled)"
  value       = module.infrastructure.mqtt_broker_url
}

output "mqtt_user" {
  description = "MQTT broker username"
  value       = module.infrastructure.mqtt_user
  sensitive   = true
}

output "mqtt_password" {
  description = "MQTT broker password"
  value       = module.infrastructure.mqtt_password
  sensitive   = true
}