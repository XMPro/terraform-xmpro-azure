...
output "key_vault_id" {
  ...
  value       = data.azurerm_key_vault.ad_key_vault.id
}

output "key_vault_name" {
  description = "The name of the AD key vault"
  value       = data.azurerm_key_vault.ad_key_vault.name
}

output "service_plan_id" {
  description = "The ID of the AD service plan"
  value       = data.azurerm_service_plan.ad_service_plan.id
}

output "service_plan_name" {
  description = "The name of the AD service plan"
  value       = data.azurerm_service_plan.ad_service_plan.name
}

output "key_vault_secret_ids" {
  description = "Map of secret names to their IDs in the AD key vault"
  value       = module.ad_secrets.secret_ids
}
