...
resource "azurerm_log_analytics_workspace" "this" {
  ...
  name                = var.log_analytics_name != "" ? var.log_analytics_name : "log-${var.company_name}${var.name_suffix != "" ? "-${var.name_suffix}" : ""}"
...
resource "azurerm_application_insights" "this" {
  ...
  name                = var.app_insights_name != "" ? var.app_insights_name : "appinsights-${var.company_name}${var.name_suffix != "" ? "-${var.name_suffix}" : ""}"
  location            = var.location
  resource_group_name = var.resource_group_name
