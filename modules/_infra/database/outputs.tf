...
output "sql_server_connection_string" {
  ...
  value       = "Server=tcp:${local.sql_server_fqdn},1433;Initial Catalog=master;Persist Security Info=False;User ID=${var.administrator_login};Password=${var.administrator_login_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
  sensitive   = true
}
